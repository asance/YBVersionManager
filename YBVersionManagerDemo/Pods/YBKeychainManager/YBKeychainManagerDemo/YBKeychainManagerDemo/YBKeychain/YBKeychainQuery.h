...
//
	...
	#define YBKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define YBKeyCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef YBKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, YBKeychainQuerySynchronizationMode) {
	YBKeychainQuerySynchronizationModeAny,
	YBKeychainQuerySynchronizationModeNo,
	YBKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface YBKeychainQuery : NSObject
...
@property (nonatomic) YBKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 YBKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
