...
#define kKeychainService                (@"asance.YBFinance")
...
/**
 Error code specific to YBKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, YBKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	YBKeychainErrorBadArguments = -1001,
};

/** YBKeychain error domain */
extern NSString *const kYBKeychainErrorDomain;

/** Account name. */
extern NSString *const kYBKeychainAccountKey;
 ...
 */
extern NSString *const kYBKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kYBKeychainClassKey;

/** Item description. */
extern NSString *const kYBKeychainDescriptionKey;

/** Item label. */
extern NSString *const kYBKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kYBKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kYBKeychainWhereKey;
...
/**
 ...
 YBKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in YBKeychain.h for a list of keys that can be used when accessing the
